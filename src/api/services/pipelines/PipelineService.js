...
const AWS = require('../../../utils/aws/requireAWS');
const getLogger = require('../../../utils/getLogger');
const { assignPodToPipeline } = require('../../../utils/hooks/assignPodToPipeline');
const { cleanupPods } = require('../../../utils/hooks/podCleanup');
...
const PlotsTablesService = require('../PlotsTablesService');
