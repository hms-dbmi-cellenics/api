const { buildStateMachineDefinition } = require('../../../src/api/services/pipelines/manage');
const { getGem2sPipelineSkeleton, getQcPipelineSkeleton } = require('../../../src/api/services/pipelines/manage/skeletons');
